...
public class MainController {
    ...
    // Обрабатываем пользователей в сессиях
    ...
    // Метод добавления продукта id в корзину пользователя id
    ...
    // Обрабатываем Метод корзина пользователя по id
    @GetMapping("/cart")
    ...
    // Метод обработки перехода на страницу заказов
    @GetMapping("/orders")
